...
{
    /// <inheritdoc />
<<<<<<<< HEAD:DataLayer/Migrations/20250614173504_init.cs
    public partial class init : Migration
========
    public partial class initial : Migration
>>>>>>>> 774f871f16fbabc31873dc504c62cfb0d7b66ba5:DataLayer/Migrations/20250614195031_initial.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GloblaAccesLevel = table.Column<bool>(type: "bit", nullable: false),
                    ProjectAccessLevel = table.Column<bool>(type: "bit", nullable: false),
                    ProjectPosition = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_CurrentStepId",
                table: "Reviews",
                column: "CurrentStepId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_InitiatorUserId",
                table: "Reviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewsFolders_FolderId",
                table: "ReviewsFolders",
                column: "FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewStepUsers_ReviewId",
                table: "ReviewStepUsers",
                column: "ReviewId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewStepUsers_StepId",
                table: "ReviewStepUsers",
                column: "StepId");
